  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <h2 className="text-2xl font-bold text-[#2D3142]">My Quotes ({quotes.length})</h2>
        <Link href="/quotes/create">
          <button className="bg-gradient-to-r from-yellow-400 to-red-400 hover:scale-105  text-white px-6 py-3 rounded-lg font-medium transition-colors flex items-center shadow-md">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16">
          ...
          <Link href="/quotes/create">
            <button className="bg-green-400 hover:bg-green-500 text-white px-8 py-4 rounded-lg font-semibold transition-colors flex items-center mx-auto shadow-lg">
